...
export default class VenuesService extends BaseService {
    private _type: string = 'VenuesManager'
    /**
     *  添加新用户
     * @param {*} obj
     */
    create(obj: object) {
        console.log('obj', config.get('userApi') + `/internal/users?_type=${this._type}`)
        let self = this
